...
aws lambda update-function-configuration --function-name driver-adapters-planetscale-lambda-basic --runtime nodejs18.x --environment "Variables={DRIVER_ADAPTERS_PLANETSCALE_LAMBDA_BASIC_DATABASE_URL=$DRIVER_ADAPTERS_PLANETSCALE_LAMBDA_BASIC_DATABASE_URL}" --timeout 10
