...
aws lambda update-function-configuration --function-name driver-adapters-postgresql-lambda-basic --runtime nodejs18.x --environment "Variables={DATABASE_URL=$DATABASE_URL}" --timeout 30
