...
pnpm wrangler pages functions build fns --compatibility-date 2024-09-23 --compatibility-flags "nodejs_compat" --outdir build/_worker.js
# Copy index.html to build folder
cp index.html build/index.html
# Now deploy the _worker.js alongside the index.html asset to Pages
pnpm wrangler pages deploy ./build -- | tee deployment-logs.txt
sleep 15
