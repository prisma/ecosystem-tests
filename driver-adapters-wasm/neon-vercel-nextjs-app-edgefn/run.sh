...
export PRISMA_TELEMETRY_INFORMATION='ecosystem-tests driver-adapters-wasm neon-vercel-nextjs-app-edgefn'

pnpm install

export VERCEL_ORG_ID=$VERCEL_ORG_ID
export VERCEL_PROJECT_ID=$DRIVER_ADAPTERS_NEON_VERCEL_NEXTJS_APP_EDGEFN_PROJECT_ID
