...
var UserUpdateManyMutationInput = /** @class */ (function () {
    function UserUpdateManyMutationInput() {
    }
    __decorate([
    ...
    ], UserUpdateManyMutationInput.prototype, "id");
    __decorate([
        TypeGraphQL.Field(function (_type) { return StringFieldUpdateOperationsInput_1.StringFieldUpdateOperationsInput; }, {
            nullable: true,
            description: undefined
        })
    ], UserUpdateManyMutationInput.prototype, "email");
    __decorate([
