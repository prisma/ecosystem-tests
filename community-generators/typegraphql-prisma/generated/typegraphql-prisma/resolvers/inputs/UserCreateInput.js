...
var UserCreateInput = /** @class */ (function () {
    function UserCreateInput() {
    }
    __decorate([
    ...
    ], UserCreateInput.prototype, "id");
    __decorate([
        TypeGraphQL.Field(function (_type) { return String; }, {
            nullable: false,
            description: undefined
        })
    ], UserCreateInput.prototype, "email");
    __decorate([
        TypeGraphQL.Field(function (_type) { return String; }, {
            nullable: true,
            description: undefined
        })
    ], UserCreateInput.prototype, "name");
    __decorate([
        TypeGraphQL.Field(function (_type) { return UserType_1.UserType; }, {
            nullable: false,
            description: undefined
        })
    ], UserCreateInput.prototype, "type");
