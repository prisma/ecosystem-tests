...
var UserMinAggregate = /** @class */ (function () {
    function UserMinAggregate() {
    }
    __decorate([
    ...
    ], UserMinAggregate.prototype, "id");
    __decorate([
        TypeGraphQL.Field(function (_type) { return String; }, {
            nullable: true,
            description: undefined
        })
    ], UserMinAggregate.prototype, "email");
    __decorate([
        TypeGraphQL.Field(function (_type) { return String; }, {
            nullable: true,
            description: undefined
        })
    ], UserMinAggregate.prototype, "name");
    __decorate([
        TypeGraphQL.Field(function (_type) { return UserType_1.UserType; }, {
            nullable: true,
            description: undefined
        })
    ], UserMinAggregate.prototype, "type");
