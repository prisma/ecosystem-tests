...
if [ "$PRISMA_CLIENT_ENGINE_TYPE" == "binary" ]; then
  echo "Binary"
  files=',"files":["index.js","index.mjs","package.json","query-engine-rhel-openssl-1.0.x","schema.prisma"]'
  ...
  files=',"files":["index.js","index.mjs","libquery_engine-rhel-openssl-1.0.x.so.node","package.json","schema.prisma"]'
  # TODO Use deployment, not production
