...
describe('should test Prisma client and PgBouncer', () => {
  ...
  it.skip('should fail with default connection string without the pgbouncer query string param', async () => {
    try {
  ...
  it('should work with default connection string with the pgbouncer query string param', async () => {
