...
This example shows how to use [Prisma Client](https://github.com/prisma/prisma-client-js) in a **simple TypeScript script** to read and write data in a database.
...
- regenerate the Prisma Client database client based on the new Prisma schema
...
```sh
npx prisma2 migrate save --experimental --name 'init'
...
### Use Prisma Migrate to persist the schema migration
...
To persist your schema migration with Prisma Migrate, run:
...
### Generate Prisma Client with the CLI

Sometimes, e.g. in CI/CD environments, it can be helpful to generate Prisma Client with a CLI command. This can be done with the `yarn prisma2 generate` command. If you want to run it in this project, you need to prepend `npx` again:
...
- Check out the [Prisma Framework docs](https://github.com/prisma/prisma2) (e.g. for [data modeling](https://github.com/prisma/prisma2/blob/master/docs/data-modeling.md), [relations](https://github.com/prisma/prisma2/blob/master/docs/relations.md) or the [Prisma Client API](https://github.com/prisma/prisma2/blob/master/docs/client/api.md))
