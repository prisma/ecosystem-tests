...
const name = `platforms-serverless-lambda-node-20-${process.env.PRISMA_CLIENT_ENGINE_TYPE}`
...
async function main() {
  ...
  let files = `,"files":["client.d.ts","client.js","default.d.ts","default.js","edge.d.ts","edge.js","index-browser.js","index.d.ts","index.js","libquery_engine-debian-openssl-1.1.x.so.node","libquery_engine-rhel-openssl-3.0.x.so.node","package.json","query_compiler_bg.wasm","query_compiler_bg.wasm","schema.prisma","wasm-edge-light-loader.mjs","wasm-worker-loader.mjs","wasm.d.ts","wasm.js"]`
  if (process.env.PRISMA_CLIENT_ENGINE_TYPE === 'binary') {
    files = `,"files":["client.d.ts","client.js","default.d.ts","default.js","edge.d.ts","edge.js","index-browser.js","index.d.ts","index.js","package.json","query-engine-debian-openssl-1.1.x","query-engine-rhel-openssl-3.0.x","query_compiler_bg.wasm","query_compiler_bg.wasm","schema.prisma","wasm-edge-light-loader.mjs","wasm-worker-loader.mjs","wasm.d.ts","wasm.js"]`
  }
