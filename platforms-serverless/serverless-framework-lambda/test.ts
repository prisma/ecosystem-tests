...
async function main() {
  ...
  const binaryString = process.env.PRISMA_CLIENT_ENGINE_TYPE === 'binary'
    ? `,"files":["deno","edge.d.ts","edge.js","edge.mjs","index-browser.js","index-browser.mjs","index.d.ts","index.js","index.mjs","package.json","query-engine-rhel-openssl-1.0.x","schema.prisma"]`
    : `,"files":["deno","edge.d.ts","edge.js","edge.mjs","index-browser.js","index-browser.mjs","index.d.ts","index.js","index.mjs","libquery_engine-rhel-openssl-1.0.x.so.node","package.json","schema.prisma"]`
