...
if [ "$PRISMA_CLIENT_ENGINE_TYPE" == "binary" ]; then
  ...
  files=',"files":["deno","edge.d.ts","edge.js","index-browser.js","index.d.ts","index.js","libquery_engine-debian-openssl-1.0.x.so.node","query-engine-debian-openssl-1.1.x","package.json","schema.prisma"]'
fi
