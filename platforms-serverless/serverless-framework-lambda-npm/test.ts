...
const name = 'e2e-tests-serverless-lambda-npm' // TODO rename to match project name again in AWS account
...
async function main() {
  ...
  const binaryString = process.env.PRISMA_CLIENT_ENGINE_TYPE === 'binary'
    ...
    : `,"files":["index-browser.js","index.d.ts","index.js","libquery_engine-rhel-openssl-1.0.x.so.node","package.json","schema.prisma"]`
