...
if [ "$PRISMA_CLIENT_ENGINE_TYPE" == "binary" ]; then
  ...
  files=',"files":["client.d.ts","client.js","default.d.ts","default.js","edge.d.ts","edge.js","index-browser.js","index.d.ts","index.js","libquery_engine-rhel-openssl-3.0.x.so.node","package.json","query_engine_bg.js","query_engine_bg.wasm","schema.prisma","wasm.d.ts","wasm-edge-light-loader.mjs","wasm-worker-loader.mjs","wasm.js"]'
fi
