  ...
  const folders = glob
    ...
    .filter((file) => {
      const ignoreFiles = [
        ...
        'platforms-serverless/vercel-cli-with-redwood/api', // Redwood uses workspaces but is included
        'platforms-serverless/vercel-cli-with-redwood/web', // Redwood uses workspaces but is included
