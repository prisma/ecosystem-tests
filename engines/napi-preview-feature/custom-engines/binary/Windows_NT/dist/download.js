    ...
    if (fs_1.default.existsSync(lockFile) &&
        ...
        const binaries = {
            [process.env.PRISMA_FORCE_NAPI === 'true'
                ...
                : fetch_engine_1.EngineTypes.queryEngine]: binaryDir,
            [fetch_engine_1.EngineTypes.migrationEngine]: binaryDir,
            [fetch_engine_1.EngineTypes.introspectionEngine]: binaryDir,
            [fetch_engine_1.EngineTypes.prismaFmt]: binaryDir,
        };
