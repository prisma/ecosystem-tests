...
var TestResolver = /** @class */ (function () {
    ...
    TestResolver.prototype.test = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        err_1 = _a.sent();
                        return [3 /*break*/, 3];
                    case 3: return [4 /*yield*/, client.user.findMany({
                            where: {
                                email: 'john@example.com'
                            }
                        })];
    ...
    __decorate([
        type_graphql_1.Query(function (returns) { return String; }, { nullable: true })
    ], TestResolver.prototype, "test");
