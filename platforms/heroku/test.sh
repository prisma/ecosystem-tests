...
if [ "$PRISMA_CLIENT_ENGINE_TYPE" == "binary" ]; then
  ...
  files=',"files":["default.d.ts","default.js","edge.d.ts","edge.js","index-browser.js","index.d.ts","index.js","libquery_engine-debian-openssl-3.0.x.so.node","runtime","package.json","schema.prisma","wasm.d.ts","wasm.js"]'
