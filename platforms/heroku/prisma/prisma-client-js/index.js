...
class PrismaClient {
    ...
    get posts() {
        throw new Error('"prisma.posts" has been renamed to "prisma.post"');
    }
    get post() {
...
function PostDelegate(dmmf, fetcher, errorFormat, measurePerformance) {
    const Post = {};
    Post.findOne = (args) => args && args.select ? new PostClient(dmmf, fetcher, 'query', 'findOnePost', 'posts.findOne', args || {}, [], errorFormat, measurePerformance) : new PostClient(dmmf, fetcher, 'query', 'findOnePost', 'posts.findOne', args || {}, [], errorFormat, measurePerformance);
    Post.findMany = (args) => new PostClient(dmmf, fetcher, 'query', 'findManyPost', 'posts.findMany', args || {}, [], errorFormat, measurePerformance);
    Post.create = (args) => args && args.select ? new PostClient(dmmf, fetcher, 'mutation', 'createOnePost', 'posts.create', args || {}, [], errorFormat, measurePerformance) : new PostClient(dmmf, fetcher, 'mutation', 'createOnePost', 'posts.create', args || {}, [], errorFormat, measurePerformance);
    Post.delete = (args) => args && args.select ? new PostClient(dmmf, fetcher, 'mutation', 'deleteOnePost', 'posts.delete', args || {}, [], errorFormat, measurePerformance) : new PostClient(dmmf, fetcher, 'mutation', 'deleteOnePost', 'posts.delete', args || {}, [], errorFormat, measurePerformance);
    Post.update = (args) => args && args.select ? new PostClient(dmmf, fetcher, 'mutation', 'updateOnePost', 'posts.update', args || {}, [], errorFormat, measurePerformance) : new PostClient(dmmf, fetcher, 'mutation', 'updateOnePost', 'posts.update', args || {}, [], errorFormat, measurePerformance);
    ...
    Post.upsert = (args) => args && args.select ? new PostClient(dmmf, fetcher, 'mutation', 'upsertOnePost', 'posts.upsert', args || {}, [], errorFormat, measurePerformance) : new PostClient(dmmf, fetcher, 'mutation', 'upsertOnePost', 'posts.upsert', args || {}, [], errorFormat, measurePerformance);
