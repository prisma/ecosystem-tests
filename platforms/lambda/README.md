...
Sometimes, e.g. in CI/CD environments, it can be helpful to generate Prisma Client with a CLI command. This can be done with the `prisma2 generate command`. If you want to run it in this project, you need to prepend `npx` again:
