...
ssh -i ./server-key.pem administrator@207.254.29.83 -tt "
    ...
    export PATH=$(printenv PATH):/opt/homebrew/bin:/opt/homebrew/sbin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/Users/administrator/.cargo/bin:/Users/administrator/.npm-global/bin
